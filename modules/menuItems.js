...
let menuTempl = function(webviews) {
        ...
        submenu: [
          {
            ...
            click() {
              ...
              if (ethereumNode.isEth) {
                ...
                if (process.platform === 'darwin') {
                  userPath += '/Library/AndusChain/keystore';
                }
                ...
                if (
                  ...
                  userPath += '/.AndusChain/keystore';
                }

                if (process.platform === 'win32') {
                  userPath = `${Settings.appDataPath}\\AndusChain\\keystore`;
                }
              }
  ...
  helpMenu.push(
    ...
    // },
    {
      ...
      click() {
        shell.openExternal('https://github.com/anduschain/daon-mist/issues');
      }
    }
  );
