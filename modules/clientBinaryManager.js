...
// should be 'https://raw.githubusercontent.com/anduschain/andusChainGethBinary/master/clientBinaries.json'
const BINARY_URL =
  'https://raw.githubusercontent.com/anduschain/andusChainGethBinary/master/clientBinaries.json';

const ALLOWED_DOWNLOAD_URLS_REGEX = /^https:\/\/(?:(?:[A-Za-z0-9](?:[A-Za-z0-9-]{0,61}[A-Za-z0-9])?\.))(?:.+)/; // eslint-disable-line max-len
