...
!define GROUPNAME "AndusChain"
!define HELPURL "https://github.com/anduschain/daon-mist"
!define UPDATEURL "https://github.com/anduschain/daon-mist"
!define ABOUTURL "https://www.anduschain.io"
...
!macro ENVFUNC un
  Function ${un}setenv
    ...
    StrCpy $NODEDATADIR "$APPDATA\AndusChain"
...
## Select the location for Daon Mist's data directory
#PageEx directory
#  DirText "Select a location for Daon Mist's data files (watched contracts, etc.)"
#  DirVar $DATADIR
#PageExEnd
